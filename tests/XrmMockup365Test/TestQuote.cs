...
namespace DG.XrmMockupTest
{
    public class TestQuote : UnitTestBase
    {
        ...
        // These tests exercise XrmMockup's WinQuote / CloseQuote / ReviseQuote request handlers against
        // the Quote / QuoteClose / QuoteDetail entities, which were removed from the environment. They
        // are preserved in original form behind an undefined compile symbol so the team can decide the
        // fix: to re-enable, provision the Quote entities, regenerate the context, then define
