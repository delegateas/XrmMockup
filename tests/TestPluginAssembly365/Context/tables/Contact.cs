...
#pragma warning restore CS8981
{
    ...
    [RelationshipMetadata("OneToMany", "contactid", "activitypointer", "regardingobjectid", "Referenced")]
    public IEnumerable<ActivityPointer> Contact_ActivityPointers
    {
        get => GetRelatedEntities<ActivityPointer>("Contact_ActivityPointers", null);
    ...
    [RelationshipMetadata("OneToMany", "contactid", "email", "emailsender", "Referenced")]
    public IEnumerable<Email> Contact_Email_EmailSender
    {
        get => GetRelatedEntities<Email>("Contact_Email_EmailSender", null);
        set => SetRelatedEntities("Contact_Email_EmailSender", null, value);
    }

    [RelationshipSchemaName("Contact_Emails")]
    [RelationshipMetadata("OneToMany", "contactid", "email", "regardingobjectid", "Referenced")]
    public IEnumerable<Email> Contact_Emails
    {
        get => GetRelatedEntities<Email>("Contact_Emails", null);
        set => SetRelatedEntities("Contact_Emails", null, value);
    }

    [RelationshipSchemaName("Contact_Faxes")]
    [RelationshipMetadata("OneToMany", "contactid", "fax", "regardingobjectid", "Referenced")]
    public IEnumerable<Fax> Contact_Faxes
    {
        get => GetRelatedEntities<Fax>("Contact_Faxes", null);
    ...
    [RelationshipMetadata("OneToMany", "contactid", "task", "regardingobjectid", "Referenced")]
    public IEnumerable<Task> Contact_Tasks
    {
        get => GetRelatedEntities<Task>("Contact_Tasks", null);
