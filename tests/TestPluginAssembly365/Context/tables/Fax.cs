...
public partial class Fax : ExtendedEntity
#pragma warning restore CS8981
{
    ...
    public Fax(Guid id) : base(EntityLogicalName, id) { }
    ...
    {
        get => GetAttributeValue<string?>("billingcode");
        set => SetAttributeValue("billingcode", value);
    }
    ...
    {
        get => GetAttributeValue<string?>("coverpagename");
        set => SetAttributeValue("coverpagename", value);
    }
    ...
    {
        get => GetAttributeValue<string?>("faxnumber");
        set => SetAttributeValue("faxnumber", value);
    }
    ...
    {
        get => GetAttributeValue<int?>("numberofpages");
        set => SetAttributeValue("numberofpages", value);
    }
    ...
    {
        get => this.GetOptionSetValue<fax_prioritycode>("prioritycode");
    ...
    /// <summary>
    /// <para>Choose the record that the fax relates to.</para>
    ...
    /// <summary>
    /// <para>Enter the related records for the fax.</para>
    ...
    public fax_statecode? StateCode
    {
        get => this.GetOptionSetValue<fax_statecode>("statecode");
    ...
    {
        get => this.GetOptionSetValue<fax_statuscode>("statuscode");
    ...
    public string? Tsid
    {
        get => GetAttributeValue<string?>("tsid");
        set => SetAttributeValue("tsid", value);
    }
    ...
    {
        get => GetRelatedEntity<BusinessUnit>("business_unit_fax_activities", null);
        set => SetRelatedEntity("business_unit_fax_activities", null, value);
    }
    ...
    {
        get => GetRelatedEntity<Contact>("Contact_Faxes", null);
        set => SetRelatedEntity("Contact_Faxes", null, value);
    }
    ...
    {
        get => GetRelatedEntities<ActivityParty>("fax_activity_parties", null);
    ...
    {
        get => GetRelatedEntity<SystemUser>("lk_fax_createdby", null);
        set => SetRelatedEntity("lk_fax_createdby", null, value);
    }
    ...
    {
        get => GetRelatedEntity<SystemUser>("lk_fax_createdonbehalfby", null);
        set => SetRelatedEntity("lk_fax_createdonbehalfby", null, value);
    }
    ...
    {
        get => GetRelatedEntity<SystemUser>("lk_fax_modifiedby", null);
        set => SetRelatedEntity("lk_fax_modifiedby", null, value);
    }
    ...
    {
        get => GetRelatedEntity<SystemUser>("lk_fax_modifiedonbehalfby", null);
        set => SetRelatedEntity("lk_fax_modifiedonbehalfby", null, value);
    }
    ...
    {
        get => GetRelatedEntity<Team>("team_fax", null);
        set => SetRelatedEntity("team_fax", null, value);
    }
    ...
    {
        get => GetRelatedEntity<TransactionCurrency>("TransactionCurrency_Fax", null);
        set => SetRelatedEntity("TransactionCurrency_Fax", null, value);
    }
    ...
    {
        get => GetRelatedEntity<SystemUser>("user_fax", null);
        set => SetRelatedEntity("user_fax", null, value);
    }

    /// <summary>
    /// Gets the logical column name for a property on the Fax entity, using the AttributeLogicalNameAttribute if present.
    /// </summary>
    ...
    public static string GetColumnName(Expression<Func<Fax, object?>> column)
    {
        return TableAttributeHelpers.GetColumnName(column);
    }

    /// <summary>
    /// Retrieves the Fax with the specified columns.
    /// </summary>
    /// <param name="service">Organization service</param>
    /// <param name="id">Id of Fax to retrieve</param>
    /// <param name="columns">Expressions that specify columns to retrieve</param>
    /// <returns>The retrieved Fax</returns>
    public static Fax Retrieve(IOrganizationService service, Guid id, params Expression<Func<Fax, object>>[] columns)
    {
